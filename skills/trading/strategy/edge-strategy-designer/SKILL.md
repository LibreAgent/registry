...
description: Convert abstract edge concepts into strategy draft variants and optional
  exportable ticket YAMLs for edge-candidate-agent export/validation.
version: 1.0.0
author: TraderMonty
license: MIT
platforms:
