...
Generates [draw.io](https://www.drawio.com/) diagrams from natural language descriptions and exports them to PNG, SVG, or PDF. Works across Claude Code, OpenClaw, LibreAgents, and Codex. 1.1k+ stars.
