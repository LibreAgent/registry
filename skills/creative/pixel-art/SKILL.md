...
```python
import sys
sys.path.insert(0, "/home/teknium/.libreagents/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.libreagents/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — LibreAgents installs package this)
