...
```bash
python3 -m pyfiglet "LIBREAGENTS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=LIBREAGENTS&font=Slant" | boxes -d stone
```
