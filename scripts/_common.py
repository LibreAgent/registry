"""Shared helpers for the LibreAgents Registry tooling."""
...
def iconify_id(meta: dict) -> str | None:
    """Return a validated Iconify id from metadata.libreagents.icon, else None."""
    icon = meta.get("icon")
...
def libreagents_meta(frontmatter: dict) -> dict:
    md = frontmatter.get("metadata") or {}
    if not isinstance(md, dict):
        return {}
    value = md.get("libreagents") or {}
