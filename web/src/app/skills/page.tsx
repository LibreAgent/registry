...
export const metadata: Metadata = {
  title: "Skills",
  description: "Browse task procedures the LibreAgents runtime can follow.",
};
...
export default async function SkillsPage({ searchParams }: { searchParams: SP }) {
  ...
  return (
    <div>
      <PageHeader
        title="Skills"
        description="Self-contained task procedures the LibreAgents runtime can follow — each a single SKILL.md following the agentskills.io open standard."
        icon={
