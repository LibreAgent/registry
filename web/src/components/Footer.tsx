...
const REPO = "https://github.com/LibreAgent/registry";
    ...
    <footer className="mt-20 border-t border-default bg-subtle">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-10 md:flex-row md:justify-between">
          <div className="max-w-sm">
            ...
            <p className="mt-4 text-sm text-muted">
              A free and open community package registry for the LibreAgents runtime.
          ...
          <div className="grid grid-cols-2 gap-10 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 text-sm">
                ...
                <li>
                  <a
                    href={`${REPO}/blob/main/THIRD_PARTY_LICENSE_NOTICES.md`}
                    className="text-muted hover:text-default"
                  >
                    License notices
                  </a>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-default pt-6 text-xs text-faint sm:flex-row">
          <p>
            Everything here is free and open. Built for the LibreAgents runtime and its
            desktop companion.
          </p>
